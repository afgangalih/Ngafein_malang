<div class="relative">
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        ...
        <a href="{{ route('user.explore.index', ['category' => $category]) }}" class="inline-flex items-center gap-2 text-xs font-bold text-[#b87c39] hover:text-[#9a662e] transition-all group shrink-0">
            LIHAT SEMUA 
