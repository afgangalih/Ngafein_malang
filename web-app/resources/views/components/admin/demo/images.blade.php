...
@section('content')
    ...
    <div class="space-y-5 sm:space-y-6">
        ...
        <x-admin.common.component-card title="Responsive Image">
            <div class="relative">
        ...
        <x-admin.common.component-card title="Image in 2 Grid">
        ...
        <x-admin.common.component-card title="Image in 3 Grid">
