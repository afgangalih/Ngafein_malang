...
@section('content')
    ...
    <div class="space-y-5 sm:space-y-6">
        <x-admin.common.component-card title="With Light Background">
        ...
        <x-admin.common.component-card title="With Solid Background">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-admin.ui.badge :color="$color" variant="solid">
                        {{ $color }}
                    </x-admin.ui.badge>
                @endforeach
            </div>
        ...
        <x-admin.common.component-card title="Light Background with Left Icon">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-admin.ui.badge :color="$color" :startIcon="$plusIcon">
                        {{ $color }}
                    </x-admin.ui.badge>
                @endforeach
            </div>
        ...
        <x-admin.common.component-card title="Solid Background with Left Icon">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-admin.ui.badge :color="$color" variant="solid" :startIcon="$plusIcon">
                        {{ $color }}
                    </x-admin.ui.badge>
                @endforeach
            </div>
        ...
        <x-admin.common.component-card title="Light Background with Right Icon">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-admin.ui.badge :color="$color" :endIcon="$plusIcon">
                        {{ $color }}
                    </x-admin.ui.badge>
                @endforeach
            </div>
        ...
        <x-admin.common.component-card title="Solid Background with Right Icon">
            <div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
                @foreach ($colors as $color)
                    <x-admin.ui.badge :color="$color" variant="solid" :endIcon="$plusIcon">
                        {{ $color }}
                    </x-admin.ui.badge>
                @endforeach
            </div>
