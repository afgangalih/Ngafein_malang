...
class CafeController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($category) {
            ...
            return view('user.explore.list', compact('cafes', 'title', 'allFasilitas', 'allMenus'));
        }
        ...
        return view('user.explore.index', compact('terdekat', 'sultan', 'menuLengkap', 'buka24jam'));
    }
    ...
    public function show($id)
    {
        ...
        return view('user.explore.detail', compact('cafe', 'rekomendasi'));
    }
